...
@Component({
  ...
  export class SwapresetComponent implements OnInit {
    ...
    obj;
    xml;
    constructor(private ngx:NgxXml2jsonService,private swapXmlServ:SwapResetService,public model:SwapResetModel)
    {}
   ...
   this.model.cntRecQuoteCalender = this.obj.reset.QuoteCalendars.qc;
    ...
    this.model.IntialRecQuoteLag= this.obj.reset.InitialQuoteLag;
